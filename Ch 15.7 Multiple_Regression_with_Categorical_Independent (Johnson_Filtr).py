...
johnson_filtration=pd.read_excel("C:\\Users\\16692\\Documents\\194 a fall 2021\(5) R files\\Ch 15.7 Multiple Regression with Categorical Independent Variables & generating norm dist. correlated random data.xlsx")
